  ...
  try {
    ...
    const opt = {
      ...
      html2canvas: {
        ...
        useCORS: true,
        onclone: (doc) => {
          // Convert unsupported color functions to RGB
          doc.querySelectorAll("*").forEach((el) => {
            const computed = window.getComputedStyle(el);

            el.style.color = computed.color; // Force RGB
            el.style.backgroundColor = computed.backgroundColor; // Force RGB
            el.style.borderColor = computed.borderColor; // Force RGB
          });
        },
      },
